...
#Lets the player decide whether to make a deal or not
    #If yes, the game ends and the player may open the remaining cases to see whether they make a good choice.
    #If no, the game continues. The player needs to open more cases.
#Displays the amount of money the player wins at the end of the game
